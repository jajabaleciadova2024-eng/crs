...
export default function ProfilePhotoFrame({
  ...
  return (
    <div
      className="w-14 h-14 sm:w-[84px] sm:h-[84px] rounded-full overflow-hidden border-2 sm:border-[3px] border-[var(--paper-raised)] shrink-0"
    ...
    >
      {avatarUrl ? (
        ...
        <div className="w-full h-full bg-gradient-to-br from-[var(--accent-soft)] to-[var(--accent-soft)]/60 text-[var(--accent-strong)] flex items-center justify-center text-[18px] sm:text-[28px] font-bold font-serif">
          {initials}
        </div>
      )}
    </div>
